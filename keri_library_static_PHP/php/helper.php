...
// Get books
function getBooks(Database $db): ?array {
...
// Get genres
function getGenres(Database $db): ?array {
...
function isBookExist(Database $db, array $args): bool {
...
// Validate arguments
function validate(array $args): void {
