...
### 3.2) Bootstrap bekötése (gyors és stabil)

**a) CSS import (main.js):**  
...
import "bootstrap"; // JS (modal, dropdown, navbar)

createApp(App).use(router).mount("#app");
```

> Ha a `bootstrap` import nem található:  
```bash
npm i bootstrap
```
...
### 3.5) App layout (Navbar + router-view)
...
<template>
  <nav class="navbar navbar-expand-lg bg-body-tertiary border-bottom sticky-top">
    <div class="container">
      <RouterLink class="navbar-brand fw-semibold" to="/">📚 Könyvtár</RouterLink>
      ...
      <div class="collapse navbar-collapse" id="navMain">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item"><RouterLink class="nav-link" to="/">Kezdőlap</RouterLink></li>
          <li class="nav-item"><RouterLink class="nav-link" to="/books">Könyvek</RouterLink></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <footer class="border-top py-3">
    <div class="container small text-secondary">© Keri Library</div>
  </footer>
</template>
      ...
      <table class="table align-middle mb-0">
        ...
        <tbody>
          <tr v-for="b in filteredBooks" :key="b.id">
            ...
            <td class="text-end">
              <div class="btn-group">
                <button class="btn btn-sm btn-outline-secondary" @click="openDetails(b)">Részletek</button>
                <button class="btn btn-sm btn-outline-primary" @click="openEdit(b)">Módosít</button>
                <button class="btn btn-sm btn-outline-danger" @click="remove(b)">Töröl</button>
              </div>
            </td>
          </tr>
          ...
          <div class="modal-body">
            ...
            <div class="row g-3">
              <div class="col-12">
                ...
                <input v-model="model.name" class="form-control" :disabled="readonly" required minlength="2" />
              </div>

              <div class="col-md-6">
                <label class="form-label">Szerző</label>
                <input v-model="model.author" class="form-control" :disabled="readonly" required minlength="2" />
              </div>
              ...
              <div class="col-12">
                ...
                <textarea v-model="model.description" class="form-control" :disabled="readonly" required minlength="2" rows="4"></textarea>
              </div>
            </div>
          </div>
